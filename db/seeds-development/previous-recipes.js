  ...
  await knex("recipes").insert([
    {
      ...
      minutes: 40,
      description:
        "Homecooked, classic chili recipe. Delicious as is, or even better served over rice or with crackers. Feel free to add your topics. I like it with cheese and sour cream.",
      instructions:
    ...
    },
    {
      ...
      minutes: 30,
      description:
        "Use as a dip with tortilla chips, to top a pizza crust or with pits chips.",
      instructions:
        "Add either canned chicken or cubed cooked chicken with other ingredients on stove. Warm at medium heat, stirring frequently until all ingredients are mixed and hot.",
      ingredients: JSON.stringify([
        {
          name: "chicken",
          quantity: 1,
